package com.gameOfThrones.got.controller;
...
import com.gameOfThrones.got.exception.BadRequestException;
import com.gameOfThrones.got.misc.CSVHelper;
import com.gameOfThrones.got.response.BattlePlacesResponse;
import com.gameOfThrones.got.response.SaveDataResponse;
import com.gameOfThrones.got.services.BattleService;
...
public class BattleControlller {
	...
	private DataEntity getBattleData(@PathVariable("battleNumber") String battleNumber)
			throws com.gameOfThrones.got.exception.BadRequestException {
		String message = "";
		try {
